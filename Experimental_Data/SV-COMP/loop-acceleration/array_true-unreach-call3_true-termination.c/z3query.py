...
_s.add(ForAll([_n1],Implies(_n1>=0,i5(_n1 + 1) == If(If(i5(_n1) >= N_var,1,0)==0,i5(_n1) + 1,i5(_n1)))))
_s.add(ForAll([_n1],Implies(_n1>=0,break_1_flag5(_n1 + 1) == If(i5(_n1) >= N_var,1,0))))
_s.add(i5(0) == 0)
