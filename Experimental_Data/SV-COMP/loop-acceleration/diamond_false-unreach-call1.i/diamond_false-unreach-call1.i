>>> file_name='sv-benchmarks/loop-acceleration/diamond_false-unreach-call1.i'
...
3. Other axioms:
(= (x3 (+ _n1 1)) (ite (== (% __VERIFIER_nondet_uint 2) 0) (+ (x3 _n1) 1) (+ (x3
 _n1) 2)))
(= (x3 0) 0)
(>= 0 (+ (- (x3 _N1)) 99))
...
3. Other axioms:
x3((_n1+1)) = ite(((__VERIFIER_nondet_uint%2)==0),(x3(_n1)+1),(x3(_n1)+2))
x3(0) = 0
(0>=(-(x3(_N1))+99))
(_n1<_N1) -> (x3(_n1)<99)
