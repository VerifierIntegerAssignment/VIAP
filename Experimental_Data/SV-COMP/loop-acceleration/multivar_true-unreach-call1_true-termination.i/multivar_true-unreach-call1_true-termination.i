>>> file_name='sv-benchmarks/loop-acceleration/multivar_true-unreach-call1_true-termination.i'
...
5. Assertion :
((_N1+__VERIFIER_nondet_uint)==(_N1+x))
...
Assertion To Prove:(_N1 + __VERIFIER_nondet_uint==_N1 + x)
Counter Example
[y1 = 1,
 _N1 = 1,
 x1 = 1024,
