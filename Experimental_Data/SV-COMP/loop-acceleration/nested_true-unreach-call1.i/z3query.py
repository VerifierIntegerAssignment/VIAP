...
_s.add(x1 == _N2)
_s.add(main == 0)
_s.add(ForAll([_n2],Implies(_n2>=0,_N1(_n2) >= 10)))
_s.add(ForAll([_n1,_n2],Implies(And(_n1 < _N1(_n2),And(_n1>=0,_n2>=0)),_f(_n1) < 10)))
_s.add(ForAll([_n2],Implies(_n2>=0,Or(_N1(_n2)==0,_N1(_n2) - 1 < 10))))
_s.add(ForAll([_n2],Implies(_n2>=0,y4(_n2 + 1) == _N1(_n2))))
_s.add(y4(0) == 0)
_s.add(_N2 >= 268435455)
_s.add(ForAll([_n2],Implies(And(_n2 < _N2,_n2>=0),_f(_n2) < 268435455)))
_s.add(Or(_N2==0,_N2 - 1 < 268435455))
