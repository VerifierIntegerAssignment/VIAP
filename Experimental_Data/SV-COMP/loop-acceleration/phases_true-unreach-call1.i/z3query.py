...
_s.add(x1 == x3(_N1))
_s.add(main == 0)
_s.add(ForAll([_n1],Implies(_n1>=0,x3(_n1 + 1) == If(x3(_n1) < 65520,x3(_n1) + 1,x3(_n1) + 2))))
_s.add(x3(0) == 0)
