...
_s.add(ForAll([_n2],Implies(_n2>=0,j5(_n2 + 1) == j5(_n2) - 1)))
_s.add(k5(0) == _N1)
_s.add(ForAll([_x2,_x1],Implies(_x2>=0,d1array5(_x1, _x2, 0) == d1array(_x1, _x2))))
_s.add(j5(0) == n)
_s.add(0 <= -j5(_N2))
_s.add(ForAll([_n2],Implies(And(_n2 < _N2,_n2>=0),j5(_f(_n2)) > 0)))
_s.add(Or(_N2==0,j5(_N2 - 1) > 0))
_s.add(_N1>=0)
_s.add(_N2>=0)
