...
_s.add(ForAll([_n1],Implies(_n1>=0,k2(_n1 + 1) == k2(_n1) - 1)))
_s.add(k2(0) == __VERIFIER_nondet_int)
_s.add((_N1>=((-(0)/2)+(__VERIFIER_nondet_int/2))))
_s.add(ForAll([_n1],Implies(And(_n1 < _N1,_n1>=0),2*_f(_n1) < __VERIFIER_nondet_int)))
_s.add(Or(_N1==0,2*_N1 - 2 < __VERIFIER_nondet_int))
_s.add(ForAll([_n2],Implies(_n2>=0,k5(_n2 + 1) == k5(_n2) - 1)))
_s.add(k5(0) == k2(_N1))
_s.add(ForAll([_x2,_x1],Implies(_x2>=0,d1array5(_x1, _x2, 0) == d1array(_x1, _x2))))
_s.add((_N2>=(-(0)+(__VERIFIER_nondet_int/2))))
