...
d2array1=Const('d2array1',arraySort)
...
d2array6=Function('d2array6',arraySort,IntSort(),IntSort(),IntSort(),IntSort())
d2array3=Function('d2array3',arraySort,IntSort(),IntSort(),IntSort(),IntSort(),IntSort())
d2array=Function('d2array',arraySort,IntSort(),IntSort(),IntSort())
_s=Solver()
_s.add(ForAll([_n],Implies(_n>=0, _f(_n)==_n)))
_s.set("timeout",60000)
_s.add(length1 == length)
_s.add(_1_PROVE1 == _1_PROVE)
_s.add(_2_PROVE1 == _2_PROVE)
_s.add(offset1 == offset)
_s.add(i1 == _N2)
_s.add(j1 == j6(_N2))
_s.add(main == 0)
_s.add(ForAll([_x3,_x2,_x1],Implies(And(_x3>=0,_x2>=0),d2array1(_x1, _x2, _x3) == d2array6(_x1, _x2, _x3, _N2))))
_s.add(nlen1 == __VERIFIER_nondet_int)
_s.add(ForAll([_x3,_x2,_x1,_n2],Implies(And(_x3>=0,And(_x2>=0,_n2>=0)),d2array3(_x1, _x2, _x3, 0, _n2) == d2array6(_x1, _x2, _x3, _n2))))
_s.add(ForAll([_n2],Implies(_n2>=0,_N1(_n2) >= 8)))
_s.add(ForAll([_n1,_n2],Implies(And(_n1 < _N1(_n2),And(_n1>=0,_n2>=0)),_f(_n1) < 8)))
_s.add(ForAll([_n2],Implies(_n2>=0,Or(_N1(_n2)==0,_N1(_n2) - 1 < 8))))
_s.add(ForAll([_n2],Implies(_n2>=0,j6(_n2 + 1) == _N1(_n2))))
_s.add(ForAll([_x3,_x2,_x1,_n2],Implies(And(_x3>=0,And(_x2>=0,_n2>=0)),d2array6(_x1, _x2, _x3, _n2 + 1) == d2array3(_x1, _x2, _x3, _N1(_n2), _n2))))
_s.add(j6(0) == j)
_s.add(ForAll([_x3,_x2,_x1],Implies(And(_x3>=0,_x2>=0),d2array6(_x1, _x2, _x3, 0) == d2array(_x1, _x2, _x3))))
