...
idBitLength=Int('idBitLength')
k=Int('k')
j=Int('j')
_3_PROVE=Const('_3_PROVE',arraySort)
RET=Int('RET')
nlen=Int('nlen')
_4_PROVE=Const('_4_PROVE',arraySort)
...
_4_PROVE1=Const('_4_PROVE1',arraySort)
material_length1=Int('material_length1')
j1=Int('j1')
_1_PROVE1=Const('_1_PROVE1',arraySort)
k1=Int('k1')
nlen1=Int('nlen1')
_3_PROVE1=Const('_3_PROVE1',arraySort)
idBitLength1=Int('idBitLength1')
