...
_s.add(j1 == j6(_N3))
_s.add(main == 0)
_s.add(ForAll([_n3],Implies(_n3>=0,(_N1(_n3)>=(-j6(_n3) + 20/_n3 + 1)))))
_s.add(ForAll([_n1,_n3],Implies(And(_n1 < _N1(_n3),And(_n1>=0,_n3>=0)),_f(_n1)*_f(_n3) + j6(_f(_n3)) + 1 < 20)))
_s.add(ForAll([_n3],Implies(_n3>=0,Or(_N1(_n3)==0,_n3*_N1(_n3) - _n3 + j6(_n3) + 1 < 20))))
_s.add(ForAll([_n3],Implies(_n3>=0,_N2(_n3) + 4 > 3)))
_s.add(ForAll([_n3,_n2],Implies(And(_n2 < _N2(_n3),And(_n3>=0,_n2>=0)),_f(_n2) + 4 <= 3)))
_s.add(ForAll([_n3],Implies(_n3>=0,Or(_N2(_n3)==0,_N2(_n3) + 3 <= 3))))
_s.add(ForAll([_n3],Implies(_n3>=0,k6(_n3 + 1) == _N2(_n3) + 4)))
_s.add(ForAll([_n3],Implies(_n3>=0,j6(_n3 + 1) == _n3*_N1(_n3) + j6(_n3) + 1)))
_s.add(k6(0) == 9)
_s.add(j6(0) == -100)
_s.add(_N3 > 100)
_s.add(ForAll([_n3],Implies(And(_n3 < _N3,_n3>=0),_f(_n3) <= 100)))
_s.add(Or(_N3==0,_N3 - 1 <= 100))
