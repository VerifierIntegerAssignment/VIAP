...
_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),maior4(_n1 + 1, _n2) == If(If(And((matriz==matriz),(_n1==_n1)),__VERIFIER_nondet_int,d2array4(matriz, _n2, _n1, _n1, _n2))>maior4(_n1, _n2),If(And((matriz==matriz),(_n1==_n1)),__VERIFIER_nondet_int,d2array4(matriz, _n2, _n1, _n1, _n2)),maior4(_n1, _n2)))))
_s.add(ForAll([_x3,_x2,_x1,_n1,_n2],Implies(And(_x3>=0,And(_x2>=0,And(_n1>=0,_n2>=0))),d2array4(_x1, _x2, _x3, _n1 + 1, _n2) == If(And((_x1==matriz),(_x3==_n1)),__VERIFIER_nondet_int,d2array4(_x1, _x2, _x3, _n1, _n2)))))
...
_s.add(ForAll([_x3,_x2,_x1,_n4],Implies(And(_x3>=0,And(_x2>=0,_n4>=0)),d2array9(_x1, _x2, _x3, 0, _n4) == d2array12(_x1, _x2, _x3, _n4))))
...
_s.add(ForAll([_x3,_x2,_x1,_n4],Implies(And(_x3>=0,And(_x2>=0,_n4>=0)),d2array12(_x1, _x2, _x3, _n4 + 1) == d2array9(_x1, _x2, _x3, _N3(_n4), _n4))))
_s.add(k12(0) == k7(_N2))
_s.add(ForAll([_x3,_x2,_x1],Implies(And(_x3>=0,_x2>=0),d2array12(_x1, _x2, _x3, 0) == d2array7(_x1, _x2, _x3, _N2))))
