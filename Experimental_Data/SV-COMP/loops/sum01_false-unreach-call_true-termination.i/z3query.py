...
n1=Int('n1')
sn1=Int('sn1')
sn3=Function('sn3',IntSort(),IntSort())
...
_s.add(ForAll([_n1],Implies(_n1>=0,sn3(_n1 + 1) == If(_n1 + 1 < 10,sn3(_n1) + 2,sn3(_n1)))))
_s.add(sn3(0) == 0)
