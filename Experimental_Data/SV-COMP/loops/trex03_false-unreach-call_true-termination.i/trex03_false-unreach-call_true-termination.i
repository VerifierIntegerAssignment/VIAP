>>> file_name='sv-benchmarks/loops/trex03_false-unreach-call_true-termination.i'
...
Program Body
{
  ...
  _1_PROVE = ((x1_var == 0) && (x1_var == 0)) && ((x1_var == 0) && (x1_var == 0)
);
  RET = 0;
}
...
5. Assertion :
(((x1_var6(_N1)==0) and (x1_var6(_N1)==0)) and ((x1_var6(_N1)==0) and (x1_var6(_
N1)==0)))
...
Assertion To Prove:And(And((x1_var6(_N1)==0),(x1_var6(_N1)==0)),And((x1_var6(_N1
)==0),(x1_var6(_N1)==0)))
Failed to Prove
